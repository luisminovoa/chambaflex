...
const PaymentScreen = ({ setView }) => {
      ...
      return (
        <div className="max-w-lg mx-auto mt-20 text-center bg-white p-8 rounded-2xl shadow-lg">
          <h2 className="text-3xl font-bold mb-4 text-primary">Confirmar Contratación</h2>
          ...
          <div className="bg-gray-200 p-6 rounded-lg mb-6">
            <div className="flex justify-between items-center text-lg">
              <span className="text-gray-800">Comisión por conexión:</span>
          ...
          <button
            ...
            className="w-full bg-primary hover:bg-blue-900 text-white font-bold py-3 px-6 rounded-lg text-lg"
          >
            Pagar y Contratar
          </button>
        </div>
