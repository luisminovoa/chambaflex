        ...
        <div className="max-w-4xl mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="text-left p-4">
            <h1 className="text-4xl font-bold text-gray-800 mb-4 leading-tight">
              La app que transforma el <span className="text-primary">trabajo informal</span> en <span className="text-secondary">oportunidad digital</span>
            </h1>
          ...
          <div>
            ...
            <div className="flex items-center justify-between mb-4">
              <button
                type="submit"
                className="w-full bg-primary hover:bg-opacity-90 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline"
              >
                Iniciar Sesión
              </button>
            </div>
